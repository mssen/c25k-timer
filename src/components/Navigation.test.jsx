...
describe('renders the correct previous and next week/day', () => {
  it('on last day of week', () => {
    const wrapper = shallow(<Navigation week={ 1 } day={ 3 } />);
    expect(wrapper).toMatchSnapshot();
  });

  it('on first day of week', () => {
    const wrapper = shallow(<Navigation week={ 3 } day={ 1 } />);
    expect(wrapper).toMatchSnapshot();
  });

  it('in middle of week', () => {
    const wrapper = shallow(<Navigation week={ 1 } day={ 2 } />);
    expect(wrapper).toMatchSnapshot();
  });
});
...
it('handles navigation to the previous day', () => {
  ...
  const wrapper = shallow(<Navigation triggerNavigation={ triggerNavigationStub } />);
...
it('handles show modal', () => {
  ...
  const wrapper = shallow(<Navigation showModal={ showModalStub } />);
